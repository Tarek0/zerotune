...
\caption[XGBoost: ZT+TPE vs TPE with increasing HPO iterations]%
{XGBoost: Comparison of ZT+TPE and TPE on real-world datasets when TPE is allowed 
...
\label{table:xgboost-convergence-summary}
\vskip 0.1in
\begin{center}
\begin{small}
\begin{sc}
...
1 & 70.0 & 20.0 & 30.0 & 0.0 \\
5 & 40.0 & 0.0 & 60.0 & 20.0 \\
10 & 10.0 & 0.0 & 90.0 & 0.0 \\
20 & 60.0 & 0.0 & 40.0 & 0.0 \\
\bottomrule
\end{tabular}
\end{sc}
\end{small}
