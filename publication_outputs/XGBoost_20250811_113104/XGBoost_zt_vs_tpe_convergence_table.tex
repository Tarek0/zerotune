...
\caption[XGBoost: ZT vs TPE with increasing HPO iterations]%
{XGBoost: Comparison of ZT and TPE on real-world datasets when TPE is allowed 
...
\label{table:xgboost-zt-vs-tpe-convergence-summary}
\vskip 0.1in
\begin{center}
\begin{small}
\begin{sc}
...
& \textbf{Best (\%)} & \textbf{Sig (\%)} \\
\midrule
0 & 90.0 & 90.0 & 10.0 & 10.0 \\
1 & 80.0 & 30.0 & 20.0 & 10.0 \\
5 & 40.0 & 0.0 & 60.0 & 30.0 \\
10 & 30.0 & 0.0 & 70.0 & 30.0 \\
20 & 10.0 & 0.0 & 90.0 & 30.0 \\
\bottomrule
\end{tabular}
\end{sc}
\end{small}
